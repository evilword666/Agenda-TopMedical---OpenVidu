...
@Component({
  selector: 'app-openvidu-video-asistencia',
  templateUrl: './openvidu-video-asistencia.component.html',
  styleUrls: ['./openvidu-video-asistencia.component.scss']
})
export class OpenviduVideoAsistenciaComponent implements OnDestroy {
